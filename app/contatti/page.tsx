...
export const metadata:Metadata={title:"Contatti | Nazionale Italiana Sanitari",description:"Contatta la Nazionale Italiana Sanitari per informazioni, candidature, progetti, iniziative e proposte di collaborazione.",alternates:{canonical:"/contatti"}};
