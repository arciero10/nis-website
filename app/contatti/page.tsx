...
export const metadata:Metadata={title:"Contatti | Nazionale Italiana Sanitari",description:"Contatta la Nazionale Italiana Sanitari per informazioni, progetti e collaborazioni.",alternates:{canonical:"/contatti"}};
