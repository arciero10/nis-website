...
export default function Page(){return <>
  ...
  <section className="section"><div className="shell legal-content">
    ...
    <p>Previo consenso, il sito utilizza Google Analytics 4 per elaborare statistiche sull’utilizzo delle pagine e comprendere come migliorare contenuti e servizi. La base giuridica di questo trattamento è il consenso, che può essere negato o revocato in qualsiasi momento tramite “Gestisci cookie” nel footer.</p>
    ...
    <p>I dati possono essere consultati dalle persone autorizzate della Nazionale Italiana Sanitari e dai fornitori tecnici strettamente necessari all’erogazione e alla sicurezza del sito, nominati responsabili del trattamento quando richiesto. Google Analytics è utilizzato come servizio di misurazione esclusivamente dopo il consenso alla categoria analitica. L’invio email del modulo è predisposto tecnicamente ma, allo stato attuale, non risulta configurato un provider email operativo.</p>
    <h2>Trasferimenti fuori dallo Spazio Economico Europeo</h2>
    <p>L’eventuale trattamento effettuato da Google Analytics è regolato dalle condizioni e dalle garanzie applicabili al servizio del relativo fornitore. Il tag di misurazione non viene caricato prima del consenso analytics. Prima dell’attivazione di un eventuale provider email dovranno essere verificate e documentate la localizzazione del trattamento e le relative garanzie per gli eventuali trasferimenti extra UE.</p>
    <h2>Revoca del consenso analytics</h2>
    <p>La preferenza può essere modificata in qualsiasi momento tramite “Gestisci cookie”. La revoca impedisce i successivi caricamenti e invii analytics dal sito e comporta la rimozione dei cookie Google Analytics accessibili all’applicazione.</p>
