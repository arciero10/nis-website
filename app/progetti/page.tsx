...
export const metadata:Metadata={title:"Progetti NIS | Salute, prevenzione e solidarietà",description:"Scopri i progetti della Nazionale Italiana Sanitari dedicati alla salute, alla prevenzione, all’inclusione e al sostegno concreto delle persone.",alternates:{canonical:"/progetti"}};
