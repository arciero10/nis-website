...
export const metadata:Metadata={title:"Progetti | Nazionale Italiana Sanitari",description:"I progetti NIS trasformano sport, salute e solidarietà in interventi concreti.",alternates:{canonical:"/progetti"}};
export default function Page(){return <>
<PageHero eyebrow="PROGETTI" title="Ogni progetto nasce" accent="per lasciare qualcosa." intro="Iniziative concrete, dedicate e verificabili per migliorare la salute delle persone, sostenere le fragilità e promuovere una società più sana e solidale." image="/images/hero-projects.jpg"><div className="hero-actions"><Link href={paypalUrl} target="_blank" rel="noopener noreferrer" className="btn btn-blue">♡ DONA ORA</Link></div></PageHero>
<section className="section soft"><div className="shell project-highlight"><div className="project-highlight-photo"><Image src="/images/progetti/il-primo-battito/consegna-policlinico-1.jpg" alt="Foto di gruppo della Nazionale Italiana Sanitari al Policlinico Umberto I" fill sizes="(max-width: 720px) calc(100vw - 40px), (max-width: 1100px) 50vw, 38vw"/></div><div className="project-text"><div className="eyebrow">PROGETTO IN EVIDENZA</div><h2>Il 1° Battito</h2><p>Il primo grande progetto benefico della NIS. Sport, emozione e solidarietà si uniscono per sostenere la salute di donne e bambini e promuovere percorsi di cura e prevenzione.</p><Link href="/progetti/il-1-battito" className="btn btn-blue">SCOPRI IL PROGETTO ›</Link></div><FundraisingCard/></div></section>
