...
<Link href="/be-nis-be-nice" className="support-card"><Icon name="people" size={52}/><h2>Diventa associato</h2><p>Unisciti alla nostra comunità di professionisti e sostenitori.</p></Link>
